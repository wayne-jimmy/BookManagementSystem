<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BookDetails.aspx.cs" Inherits="BMS.Web.Views.BookDetails" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="row">
            <div class="col">
                ...
                <asp:LinkButton ID="lnkbtnDelete" runat="server" CssClass="btn btn-danger" OnClick="lnkbtnDelete_Click">
                    Delete
                </asp:LinkButton>
